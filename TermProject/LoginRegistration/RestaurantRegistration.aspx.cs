...
namespace TermProject
{
    public partial class RestaurantRegistration : System.Web.UI.Page
    {
        ...
        protected void CreateAccount_Click(object sender, EventArgs e)
        {
            try
            {
                dbm.CreateNewRestaurant(txtRestaurantId.Text, txtPassword.Text, txtRestaurantEmail.Text, txtAddress.Text,
                txtLogo.Text, txtRestaurantPhone.Text, txtName.Text);

                Wallet wallet = new Wallet();
                wallet.Name = txtName.Text;
                wallet.Address = txtAddress.Text;
                wallet.Email = txtRestaurantEmail.Text;
